...
/*** Changeable Values ***/
DECLARE @Version AS VARCHAR(10) = 'Actuals'
DECLARE @YearContext AS VARCHAR(10) = 'PY2'
DECLARE @MonthNumber AS NVARCHAR(20) = '12'
DECLARE @ForecastType AS NVARCHAR(20) = ''
DECLARE @FactTable AS NVARCHAR(25) = 'byPC'
DECLARE @MCBOnly AS TINYINT = 1
/*** Changeable Values ***/
...
DECLARE @Budget AS NVARCHAR(MAX) = '
            ...
            SELECT
                ...
                /* Made up 13 = Budget (1-12 are mercury Forecast)*/
...
DECLARE @Actuals AS NVARCHAR(MAX) = '
            ...
            SELECT
                ...
                /* Made up 14 = Actuals (1-12 are mercury Forecast)*/
                [ForecastTypeId]                = 0,
                A.[StaffingResourceTypeId]      [StaffingResourceTypeId],
